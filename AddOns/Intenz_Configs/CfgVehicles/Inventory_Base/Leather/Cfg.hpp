	...
	class DamageSystem
	{
		class GlobalHealth
		{
			class Health
			{
				...
				healthLevels[]=
				{
					{1,{"DZ\gear\consumables\data\tanned_leather.rvmat"}},
					{0.69999999,{"DZ\gear\consumables\data\tanned_leather.rvmat"}},
					{0.5,{"DZ\gear\consumables\data\tanned_leather_damage.rvmat"}},
					{0.30000001,{"DZ\gear\consumables\data\tanned_leather_damage.rvmat"}},
					{0,{"DZ\gear\consumables\data\tanned_leather_destruct.rvmat"}}
				};
			};
		};
	};
