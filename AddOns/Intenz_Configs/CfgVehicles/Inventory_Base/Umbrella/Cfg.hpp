class Umbrella: Inventory_Base
	{
		...
		model="\IntenZ_Configs\CfgVehicles\Inventory_Base\Umbrella\Umbrella_Closed.p3d";
...
class Umbrella_Open: Inventory_Base
	{
		...
		displayName="Umbrella";
		descriptionShort="Umbrella";
		model="\IntenZ_Configs\CfgVehicles\Inventory_Base\Umbrella\Umbrella_Open.p3d";
		bounding="BSphere";
