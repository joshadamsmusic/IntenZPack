...
class LightingNew
{
	class C_Night
	{
		...
		ambient[] = {0.016,0.0316,0.048};				// shadows
		...
		desiredLuminanceCoef = -0.075;					// luminance
	...
	class O_Night
	{
		...
		bidirect[] = {0.0, 0.0, 0.0};
		bidirectCloud[] = {0.0, 0.0, 0.0};
		ambient[] = {0.024,0.024,0.034};
		ambientCloud[] = {0.024,0.024,0.034};
