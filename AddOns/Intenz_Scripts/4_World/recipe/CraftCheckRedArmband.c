class CraftCheckRedArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft Checkered Red Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Shirt_RedCheck");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CheckRed_Armband");//add results here
