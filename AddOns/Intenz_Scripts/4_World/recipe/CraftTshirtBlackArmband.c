class CraftTshirtBlackArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft Black T-Shirt Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TShirt_black");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TShirtblack_Armband");//add results here
