class CraftPoliceArmband extends RecipeBase
{		
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"PoliceJacket");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Police_Armband");//add results here
