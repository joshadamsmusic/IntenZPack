class CraftTshirtBlueArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft Blue T-Shirt Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TShirt_blue");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TShirtblue_Armband");//add results here
