class CraftModdedTannedLeather extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Tan Soft Leather";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SoftLeather");//you can insert multiple ingredients this way
		...
		m_IngredientAddQuantity[1] = -2500;// 0 = do nothing
