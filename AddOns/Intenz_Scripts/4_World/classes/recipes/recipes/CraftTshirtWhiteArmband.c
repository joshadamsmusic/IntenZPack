class CraftTshirtWhiteArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft White T-Shirt Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TShirt_White");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TShirtWhite_Armband");//add results here
