class CraftPoliceKamyArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft Police Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"PoliceJacketOrel");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("PoliceKamy_Armband");//add results here
