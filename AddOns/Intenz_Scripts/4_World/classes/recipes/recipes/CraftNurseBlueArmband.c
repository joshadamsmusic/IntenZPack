class CraftNurseBlueArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft Blue Nurse Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"NurseDress_Blue");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("NurseBlue_Armband");//add results here
