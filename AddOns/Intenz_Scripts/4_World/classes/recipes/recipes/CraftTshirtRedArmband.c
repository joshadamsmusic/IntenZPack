class CraftTshirtRedArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft Red T-Shirt Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TShirt_Red");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TShirtRed_Armband");//add results here
