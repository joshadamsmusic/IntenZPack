class CraftTshirtGreyArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft Grey T-Shirt Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TShirt_Grey");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TShirtGrey_Armband");//add results here
