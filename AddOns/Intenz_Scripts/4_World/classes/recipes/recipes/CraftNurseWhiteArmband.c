class CraftNurseWhiteArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft White Nurse Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"NurseDress_White");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("NurseWhite_Armband");//add results here
