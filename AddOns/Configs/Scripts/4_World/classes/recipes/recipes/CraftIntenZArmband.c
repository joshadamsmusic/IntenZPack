class CraftIntenzArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft IntenZ Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Intenz_TShirt");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Intenz_Armband");//add results here
