class CraftPrisonArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft Prison Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"PrisonUniformJacket");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Prison_Armband");//add results here
