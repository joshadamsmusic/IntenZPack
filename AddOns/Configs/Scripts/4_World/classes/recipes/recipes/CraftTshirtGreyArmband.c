class CraftTshirtGreenArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft Green T-Shirt Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TShirt_Green");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TShirtGreen_Armband");//add results here
