class CraftTshirtBeigeArmband extends RecipeBase
{		
	override void Init()
	{
		m_Name = "Craft Beige T-Shirt Armband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TShirt_Beige");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TShirtBeige_Armband");//add results here
